...
`add_resources()` scans a directory, infers the resource type of each
file from its name (see `?infer_resource_type` for the full pattern
table), and appends the result to the existing resources list. Repeat
