...
The goal of `rxs2tria` is to prepare, quality check and harmonize a collection of QWA images, corresponding ROXAS output files and accompanying metadata for submission as a dataset to the QWA database.
...
To provide the additional metadata required (e.g. site and tree information, author details, ...) for the submission of a dataset, you can use the interactive Shiny app which is part of this package.
...
To check the coverage and add ring quality flags and setting years to exclude:
